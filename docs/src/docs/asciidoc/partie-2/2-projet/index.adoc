...
.Code front
****
Le but de ce projet est de discuter de problématiques serveur.

Le code front (html, css, js) est très en dessous de ce qui est exigible pour un vrai site professionnel.
****
