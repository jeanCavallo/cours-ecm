...
[source.terminal]
----
projects$ git clone https://github.com/{username}/cours-ecm <1>
...
IMPORTANT: Afin de naviguer rapidement vers une classe, il est possible d'utiliser le raccourci kbd:[⌘+n]
