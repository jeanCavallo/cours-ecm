...
== [[JSP-1]]JSP-1 : il manque un 's' dans l'entrée "Toutes les recette" du menu
...
== [[JSP-2]]JSP-2 : le lien vers les mentions légales est incorrect
...
== [[JSP-3]]JSP-3 : format de la date dans recette.tag
...
== [[JSP-4]]JSP-4 : liste des tags avec forEach
...
== [[JSP-5]]JSP-5 : factorisation du header
...
== [[JSP-6]]JSP-6 : format du texte dans recette.tag
...
== [[JSP-7]]JSP-7 : auto complétion des tags
...
== [[JSP-8]]JSP-8 : ajouter du sel et du poivre
...
== [[JSP-9]]JSP-9 : index dans les tableaux d'ingrédients
