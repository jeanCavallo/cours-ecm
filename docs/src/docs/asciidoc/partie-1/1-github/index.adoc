...
Il doit être simple d'utilisation et facile de naviguer dans l'historique.

De tous les système récents, *git* est le plus à la mode.

.Précison
****
C'est un *distributed VCS* (DVCS) et suit donc une philosophie particulière.

Il multiplie les capacités de travail dans des branches (locales ou distantes) permettant de travailler simultanément sur plusiseurs sujets en parallèle.
****

Il est particulièrement adapté aux projets open source avec des bureaux dématérialisés et les collaborateurs multiples.
...
http://www.amazon.fr/Pro-Git-Scott-Chacon/dp/1484200772/ref=sr_1_1?ie=UTF8&qid=1438869528&sr=8-1&keywords=git[Pro Git] permet de comprendre les mécaniques et la philosophie de git.
****
