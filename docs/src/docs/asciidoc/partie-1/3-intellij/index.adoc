...
Mon expérience est que, malgré les qualités des autres produits, la famille de produits de JetBrains (dont Intellij) reste très supérieur.

Chacun donc son avis, vous avez le mien.
****
...
Soit on active la mise à jour automatique (j'ai déjà quelques soucis avec cette option).
--
