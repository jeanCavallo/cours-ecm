...
On pourrait utiliser le shell mais une interface graphique est plus accessible pour débuter.

Malheureusement, il n'existe pas beaucoup de clients graphiques à la hauteur.
