...
* On se place en tant qu'utilisateur de ce que l'on construit
...
Pour le moment, on est a peu près sûr que cette classe ne fait ce qu'elle devrait.
...
Après cela, pour le moment, il n'y a pas grand chose à améliorer (refactor).
...
Elle simplifie l'activité de coding et aide à produire du code plus ouvert.

Le TDD n'est pas une spécificité java, cela s'applique à tous les languages.

http://www.amazon.fr/Test-Driven-Development-Kent-Beck/dp/0321146530[Test Driven Development: By Example] explique les mécaniques du développement par les tests.
****
